...
def minimax(board, is_maximizing) -> tuple:
    ...
    if is_maximizing:  # AI's turn
        best_score = float(
            "-inf")  # Initialize best score as the worst possible
        ...
        for cell in list_of_free_cells(board):  # For each possible move
            ...
            board[
                cell] = None  # Leave the cell as it was after evaluating that branch
...
def check_winner(board):
    ...
    for combination in WINNING_COMBINATIONS:
        if all(board[cell] == board[combination[0]] != None
...
def machine_move(board, level="minimax"):
    board[random_move(board) if level ==
          "random" else minimax_move(board)] = AI
...
def display_board(board: dict):
    ...
    print("+-------+-------+-------+")
    print("|       |       |       |")
    print("|  ", cell_display(1), "  |  ", cell_display(2), "  |  ",
          cell_display(3), "  |")
    print("|       |       |       |")
    print("+-------+-------+-------+")
    print("|       |       |       |")
    print("|  ", cell_display(4), "  |  ", cell_display(5), "  |  ",
          cell_display(6), "  |")
    print("|       |       |       |")
    print("+-------+-------+-------+")
    print("|       |       |       |")
    print("|  ", cell_display(7), "  |  ", cell_display(8), "  |  ",
          cell_display(9), "  |")
    print("|       |       |       |")
    print("+-------+-------+-------+")
